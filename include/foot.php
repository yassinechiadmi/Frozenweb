<footer>
  <div class="wut">
    <ul>
      <li><a href="https://discord.gg/VN5NPnjkj9" target="_blank"><img id="fb" src="rs/Discord.png" alt="discord" style="height: 50px;"></a></li>
      ...
      <li><a href="#top"><img id="go-top" src="rs/arrow-up-solid.svg" style="height: 50px; right: 0;"></a></li>
    </ul>
